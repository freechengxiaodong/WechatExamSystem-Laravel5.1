...
@section('content')
    ...
    <form action="{{url('/studentInfoInsert')}}" method="post" style="height: 300px;width: 80%;margin-top: 60px">
        <div class="weui-cells__title" style="font-size: 22px;text-align: center;color: green;margin-top: 80px">学生信息绑定</div>
        <div class="weui-cell" style="border: 1px solid black">
        ...
        <div class="weui-cell" style="border: 1px solid black;margin-top: 5px">
        ...
        <button class="weui-btn weui-btn_plain-primary" style="width: 100%;margin-top: 40px">确认提交</button>
    </form>
