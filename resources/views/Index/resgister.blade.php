...
@section('content')
    ...
    <form action="{{url('/studentInfoInsert')}}" method="post" style="border: 1px solid darkgray;border-radius: 10px;height: 300px;width: 80%;margin-top: 100px">
        ...
        <div class="weui-cell">
            ...
            <div class="weui-cell__bd">
                <input class="weui-input" type="number" name="name" pattern="[0-9]*" placeholder="请输入姓名">
            </div>
        </div>
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label" style="width: 60px">班级</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" type="number" name="class" pattern="[0-9]*" placeholder="请输班级">
            </div>
        </div>
        <div class="weui-cell">
        ...
        <button class="weui-btn weui-btn_plain-primary" style="width: 80%;margin-top: 40px">确认提交</button>
    </form>
