...
@section('content')
    ...
    <form action="{{url('/studentInfoInsert')}}" method="post" style="height: 300px;width: 80%;margin-top: 60px">
        ...
        <div class="weui-cell" style="border: 1px solid grey;border-radius: 3px;margin-top: 50px;">
        ...
        <div class="weui-cell" style="border: 1px solid grey;border-radius: 3px;margin-top: 10px">
